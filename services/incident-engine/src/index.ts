...
import { severityRouter } from './routes/severity.js';
import { respondersRouter } from './routes/responders.js';
import { timelineRouter } from './routes/timeline.js';
import { suggestedRunbooksRouter } from './routes/suggested-runbooks.js';
...
app.use('/incidents', statusRouter);
app.use('/incidents', severityRouter);
app.use('/incidents', respondersRouter);
app.use('/incidents', timelineRouter);
app.use('/runbooks', runbooksRouter);
app.use('/incidents', postmortemRouter);
app.use('/incidents', suggestedRunbooksRouter);
...
async function start(): Promise<void> {
  ...
  app.listen(config.port, () => {
    console.log(`incident-engine listening on port ${config.port}`);
  });
}
